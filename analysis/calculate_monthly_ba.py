...
if __name__ == "__main__":
    ...
    python_ba_gb = run_inferno(
        ...
        fapar_factor=-5.519321198636323,
        fapar_centre=0.6496361388502392,
        fuel_build_up_factor=23.96904539196143,
        fuel_build_up_centre=0.3817651088623484,
        temperature_factor=0.14724692191703254,
        temperature_centre=282.01366863077135,
        dry_day_factor=2.0e-2,
        dry_day_centre=1.73e2,
        dryness_method=2,
        rain_f=1.498223679431201,
        vpd_f=1029.125180972032,
        dry_bal_centre=-1.512165346181446,
        dry_bal_factor=-40.650353829370424,
