...
from python_inferno.hdmr_sa import SAMetric, analyse_sis, sis_calc
...
if __name__ == "__main__":
    ...
    valid_hdmr_sis = {land_index: sis for land_index, sis in hdmr_sis.items() if sis}

    for metric in SAMetric:
        metric_hdmr_sis = {
            land_i: sis[metric]
            for land_i, sis in valid_hdmr_sis.items()
            if metric in sis
        }
